...
@include('layouts.simple.calendar')
@endsection
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- You can add other actions here if needed, like edit or delete, based on user roles -->
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
...
<script>
    $(document).ready(function () {
        ...
        $('#calendar').fullCalendar({
            editable: false, // Make the calendar non-editable
